...
const nombre1 = 'Maxi, ';
console.log(nombre1.concat('Holis'));
...
console.log(arrayFiltrandoPalabras);
...
const find = array1.find((item) => item > 5); //devuelve el 6
console.log(find);
...
console.log(arrayNumeros1.reduce((a, b) => a + b));
